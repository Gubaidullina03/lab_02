...
В данном запросе клиент вводит предпочитаемую кодировку символов. Но поскольку современные серверы обычно используют UTF-8 по умолчанию, сервер и так выдал контент в UTF-8.
