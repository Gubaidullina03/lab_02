...
Характеристики:
Ручное управление - вы сами вводите каждый заголовок
Видно "сырой" протокол - учит понимать HTTP
Нет зависимостей - встроен в большинство систем
Только простые запросы - сложно делать POST, авторизацию
Нет автоматизации - нельзя использовать в скриптах
Нет обработки ответов - ответ выводится как есть
