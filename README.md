...
И так как происходит перенаправление Location: https://lenta.ru/, мы попробуем выполнить соединение через утилиту curl:


```
curl -v https://lenta.ru/
```
После успешного подключения получим следующий результат:


<img width="606" height="374" alt="Screenshot_265" src="https://github.com/user-attachments/assets/f6798b96-8eb4-47ed-953b-54c99f858a5b" />
...
## Создание ограничения количества запросов
...
- Терминал 1 ("Кухня"). Убедимся, что в одном терминале у вас запущено Flask приложение. Мы будем видеть строки вроде * Running on http://127.0.0.1:5000. Закрывать его не будем.
...
Получим результат, который показывает положительный отвтет: 


<img width="544" height="270" alt="Screenshot_38" src="https://github.com/user-attachments/assets/ac9dead7-b27d-47d4-b3d4-4857d369dea5" />



Тест 2. Работает ли ограничение по количеству запросов
